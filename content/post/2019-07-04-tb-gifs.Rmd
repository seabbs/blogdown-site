...
Using `plot_annual_change` we can now generate first a `ggplot` density of plot of the annual percentage change in countries TB incidence rates. This is again transformed into to a GIF using `gganimate`. 
