...
Success! However, it has a much longer run time of over 2 minutes - not good. We again see (this time using the [`nvtop`](https://github.com/Syllo/nvtop) tool) that resource use varies over time on the GPU.
