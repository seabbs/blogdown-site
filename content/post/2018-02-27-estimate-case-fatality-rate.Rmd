---
title: "Exploring Estimates of the Tuberculosis Case Fatality Rate - with getTBinR"
author: "null"
date: '2018-02-27'
...
Finally we summarise this post using `patchwork`, a great new package by [Thomas Pederson](https://twitter.com/thomasp85), which lets you easily compose ggplot plots into a single plot. The resulting storyboard (below) neatly summarises the exploratory plots, and the narrative they provide, that we have made in this post.
